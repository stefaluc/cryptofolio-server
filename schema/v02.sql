...
CREATE OR REPLACE FUNCTION transactions_by_user_by_date(in_user_id INT, date_start TIMESTAMP, date_end TIMESTAMP)
DECLARE ref refcursor;
BEGIN
  OPEN ref FOR SELECT * FROM "transaction" t, "balance" b
